---
title: "Aggregator Operation"
description: "Aggregator initialization, swap functions, distribution math, administrative functions, and the adapter interface."
---
...
<Frame caption="Figure 1: Aggregator initialize function operations diagram.">
  <img src="/images/captura-de-pantalla-2024-09-05-a-las-11-37-59.png" alt="Figure 1: Aggregator initialize function operations diagram." />
</Frame>
...
<Frame caption="Figure 2: Aggregator swap functions operations diagram.">
  <img src="/images/captura-de-pantalla-2024-09-05-a-las-11-22-43.png" alt="Figure 2: Aggregator swap functions operations diagram." />
</Frame>
...
<Frame caption="Figure 3: Adapter swap functions and data fetchers diagram.">
  <img src="/images/captura-de-pantalla-2024-09-05-a-las-12-02-52.png" alt="Figure 3: Adapter swap functions and data fetchers diagram." />
</Frame>
