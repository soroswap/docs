...
To see how token swaps work in practice, and to walk through the lifecycle of a swap, check out [Swaps](../../01-protocol-overview/broken-reference/). Or, to see how liquidity pools work, see [Pools](../../additional-resources/01-concepts/02-pools.md).
