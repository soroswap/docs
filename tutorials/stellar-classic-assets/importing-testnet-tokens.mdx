---
title: "Importing Testnet Tokens"
description: "Breakdown of the Bash script that imports and wraps Stellar Classic testnet assets for Soroban."
---
...
- The [Stellar CLI](https://developers.stellar.org/docs/tools/developer-tools/cli/stellar-cli) installed.
...
3. **Wrapping Assets**
   ...
   ```bash
   TOKEN_ADDRESS=$(stellar contract id asset --network "$NETWORK" --asset "$ASSET")
   ```
