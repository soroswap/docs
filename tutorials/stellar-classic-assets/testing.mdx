---
title: "Test Stellar Classic Assets"
description: "Getting test tokens from the random_tokens API endpoint and testing asset wrapping on testnet."
---
...
![](/images/tutorials/stellar-classic-assets/wrapping/wrapping-process-modal.png)

5. Click on the asset, and a wrapping modal will appear, guiding you through the wrapping process.

![](/images/tutorials/stellar-classic-assets/wrapping/wrapping-view.png)
