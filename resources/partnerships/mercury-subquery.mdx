---
title: "Collaboration with Mercury and SubQuery"
description: "Soroswap's work with the Mercury and SubQuery indexers, with setup steps for both."
---
...
6. Run the container: `bash run.sh`
...
However, storing blockchain history requires access to an archive node, which adds an operational dependency: you either run one yourself or rely on a provider that does. This is the main trade-off to weigh against a fully managed indexing service.
