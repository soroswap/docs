---
title: "Router"
description: "The Router finds direct and multi hop swap routes across liquidity pools and validates known tokens."
---

The [**Router** in Soroswap Finance ](https://www.npmjs.com/package/soroswap-router-sdk)is a key component of the protocol that facilitates interactions with multiple [**Liquidity Pools**.](/concepts/liquidity-pools) Liquidity Pools are always formed between two tokens, creating what are known as **Pairs**. For example, a pool might be between Token A and Token B, forming the pair **A:B**.
...
### [Router Methods](/api/optimal-route)
