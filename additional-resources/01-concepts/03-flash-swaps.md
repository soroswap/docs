...
* To see how to integrate a flash swap in your smart contract read [Using Flash Swaps](../../old_docusaurus/docs/guides/smart-contract-integration/using-flash-swaps/).
