...
description: "Aggregator architecture, adapters, DexDistribution calculation, and the operational flow of a swap."
---
...
<Frame caption="Aggregator Initialization Diagram.">
  <img src="/images/captura-de-pantalla-2024-09-06-a-las-10-38-26.png" alt="Aggregator Initialization Diagram." />
</Frame>

**Swap Requests**: Whenever a user initiates a swap, the [**Soroswap Router SDK** ](https://www.npmjs.com/package/soroswap-router-sdk)calculates the optimal way to distribute the swap using **`DexDistribution`**`.` This process is illustrated in **Figure: Aggregator Function Diagram** and involves:
...
<Frame caption="Aggregator Function Diagram">
  <img src="/images/captura-de-pantalla-2024-09-06-a-las-10-42-11.png" alt="Aggregator Function Diagram" />
</Frame>
