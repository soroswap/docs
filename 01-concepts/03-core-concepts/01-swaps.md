...
* To see how to implement token swaps in a smart contract read [Trading from a smart contract](../../03-technical-reference/04-SoroswapRouter.md#swap\_exact\_tokens\_for\_tokens).
