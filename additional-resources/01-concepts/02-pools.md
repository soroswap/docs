...
* To see how to pool tokens in a smart contract read [Providing Liquidity](../../smart-contracts/01-protocol-overview/03-technical-reference/03-smart-contracts/04-soroswaprouter.md#add_liquidity).
