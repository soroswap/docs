...
description: "Liquidity provider returns and impermanent loss, explained with a worked example and price ratio figures."
---
...
> * "Which we can plot out to get a general sense of the scale of the impermanent loss at different price ratios:" ![Impermanent loss against price ratio](/images/concepts/impermanent-loss-curve.png)
