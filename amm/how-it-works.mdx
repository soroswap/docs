...
![](/images/captura-de-pantalla-2024-09-20-a-las-15-42-48.png)
...
![](/images/captura-de-pantalla-2024-09-20-a-las-16-20-55.png)
...
To see how token swaps work in practice, and to walk through the lifecycle of a swap, check out [Swaps](/concepts/swap). Or, to see how liquidity pools work, see [Pools](/concepts/liquidity-pools).
