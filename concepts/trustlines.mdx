---
title: "Trustlines"
description: "Trustlines authorize an account to hold a Stellar asset, required for pool participation and swaps."
---
...
![](/images/captura-de-pantalla-2025-04-29-a-las-15-07-00.png)
...
To participate in a[ liquidity poo](/tutorials/adding-liquidity)l and perform [swaps](/tutorials/doing-swap) on Soroswap Finance, you need to establish trustlines for the following three types of assets:
