---
title: "Glossary"
description: "Definitions of key Soroswap and automated market maker terms used across the documentation."
---
...
The automated market making algorithm used by Soroswap. See [x\*y=k](/amm/glossary#x--y--k).
