...
description: "To get started, you need a wallet compatible with the Stellar network and able to interact with Soroban smart contracts. Here's how to choose one and connect it."
icon: wallet
---
...
> To learn how to use  [Soroswap Testnet Overview](/tutorials/soroswap-testnet-overview).
