---
title: "Soroswap Testnet Overview"
description: "Overview of Soroswap as an AMM on Stellar, its main sections and benefits, and what you can try on testnet."
---
...
**Soroswap is live on Stellar mainnet, and it also runs on testnet, where you can try everything without risking real funds.** In both environments it provides the same key features and benefits:

* **Balance Section:** Conveniently view your token balances in the Balance section. This feature allows you to keep track of your assets and monitor their availability for transactions within the app.
...
Did you like it? Please give us feedback. Join our [Discord channel](https://discord.gg/A2rQ3cm9XG).
