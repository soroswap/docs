...
description: "Liquidity pools as markets for a token pair, covering pool tokens, fees, and why pools replace order books."
---
...
![](/images/captura-de-pantalla-2025-04-24-a-las-15-09-28.png)
...
* [Understanding Returns](/concepts/advanced/understanding-returns)
* [Fees](/concepts/fees)
...
* To see how to pool tokens in a smart contract read [Providing Liquidity](/amm/technical-reference/contracts/soroswap-router#add_liquidity).
