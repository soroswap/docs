---
title: "Doing Swap"
description: "Performing a token swap on Soroswap, covering wallet connection, trustlines, confirmation, and best practices."
---
...
<Note>
  The screenshots on this page were captured in 2024. The steps still describe the flow, but the interface may look different from what you see today.
</Note>

## Step 1: Access Soroswap

Open the Soroswap app at [app.soroswap.finance](https://app.soroswap.finance). This takes you straight to the swap interface.
...
![](/images/captura-de-pantalla-2024-09-18-a-las-18-21-42.png)
...
![](/images/captura-de-pantalla-2024-09-18-a-las-18-44-15.png)

## Step 4: Execute a Token Swap

1. **Select Tokens:** Choose the tokens you wish to swap from and to.

![](/images/captura-de-pantalla-2024-09-18-a-las-18-28-46-1.png)

2. **Enter Amount:** Specify the amount of tokens you want to exchange.

![](/images/captura-de-pantalla-2024-09-18-a-las-18-51-21.png)
...
![](/images/captura-de-pantalla-2024-09-18-a-las-18-30-06.png)
...
![](/images/captura-de-pantalla-2024-09-18-a-las-19-16-39.png)

For more information, refer to the official documentation on [trustlines](/concepts/trustlines).

## Step 6: Confirm the transaction

1. **Sign the Transaction:** Your wallet will display the transaction details. Review and approve it to confirm the swap.

![](/images/captura-de-pantalla-2024-09-18-a-las-16-20-22.png)

Congratulations! You have successfully completed a swap on Soroswap.Finance Now.\\

![](/images/captura-de-pantalla-2024-09-18-a-las-21-01-45.png)
...
![](/images/captura-de-pantalla-2024-09-18-a-las-21-58-54.png)
