...
description: "Installing the Freighter browser wallet, securing the recovery phrase, and switching to Stellar testnet."
---
...
1.  Open the Settings menu, by clicking the gear in the botom right corner:
    ...
    ![](/images/tutorials/installing-freighter/gear.png)
2.  Open the Preference menu

    ![](/images/tutorials/installing-freighter/preferences.png)
3.  Enable experimental mode

    ![](/images/tutorials/installing-freighter/experimental-mode.png)
