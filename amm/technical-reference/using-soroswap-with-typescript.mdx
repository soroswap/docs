...
description: "Build, sign, and send Soroswap router transactions from TypeScript with the Stellar SDK."
---
...
In order to execute our operations on the blockchain, we will first need to create a transaction to send ([Forward](/amm/technical-reference/using-soroswap-with-typescript#methods) in this guide you will find the available methods and their predefined parameters):
...
>
> * [Add\_liquidity](/amm/technical-reference/using-soroswap-with-typescript#add-liquidity-to-a-pool): "add\_liquidity"
> * [Remove\_liquidity](/amm/technical-reference/using-soroswap-with-typescript#remove-liquidity-from-a-pool): "remove\_liquidity"
> * [Swap](/amm/technical-reference/using-soroswap-with-typescript#swap): "swap\_exact\_assets\_for\_assets"

### Add liquidity to a pool:

<Note>
`method: "add_liquidity"` [Reference](/amm/technical-reference/contracts/soroswap-router#add\_liquidity)
</Note>
...
<Note>
`method: "remove_liquidity"` [Reference](/amm/technical-reference/contracts/soroswap-router#remove\_liquidity)
</Note>
...
<Note>
`method: "swap_exact_assets_for_assets"` [Reference](/amm/technical-reference/contracts/soroswap-router#swap\_exact\_tokens\_for\_tokens)
</Note>
...
This is why we at Soroswap have developed [soroswap-router-sdk](https://www.npmjs.com/package/soroswap-router-sdk), a tool that helps you find the most efficient route for exchanging assets, taking into account the available reserves in Soroswap's liquidity pools.
...
This will give us the `route` object, which contains an ordered array of addresses representing the most optimal route for the exchange within the `trade.path` property. If you need more information on how to use the Router-sdk or how it works, you can do it directly in the repository of [soroswap-router-sdk on npm](https://www.npmjs.com/package/soroswap-router-sdk)
