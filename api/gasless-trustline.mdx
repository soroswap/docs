---
title: "Gasless Trustline"
description: "Sponsored trustline creation bundled into a single SDEX swap, so users onboard without holding XLM."
icon: bolt
---
...
<Info>
New to trustlines? Read the [Trustlines concept page](/concepts/trustlines) first. In short: on Stellar, an account must open a **trustline** — and lock up a small XLM base reserve — before it can hold any non-native asset.
</Info>
...
- [Trustlines — concept](/concepts/trustlines)
- [Quick Start Guide](/api/quickstart)
- [Beginner Tutorial](/api/beginner-guide)
- [Optimal Route](/api/optimal-route)
