...
[**Soroswap**](https://soroswap.finance) is the first decentralized exchange (DEX) and exchange aggregator built on the [Stellar ](https://stellar.org)blockchain, developed by [**PaltaLabs**](https://paltalabs.io).\
