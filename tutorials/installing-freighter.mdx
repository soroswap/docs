---
title: "Installing Freighter"
description: "Installing the Freighter browser wallet, securing the recovery phrase, and choosing which Stellar network to use."
---
...
![](/images/tutorials/installing-freighter/phrase.png)
...
![](/images/tutorials/installing-freighter/confirm-phrase.png)
...
1.  Open the Freighter extension in your browser.
    ...
    ![](/images/tutorials/installing-freighter/account.png)
...
Soroban is the smart contract environment of Stellar, not a separate network, so there is nothing extra to enable in Freighter. All you need to do is pick which network your wallet connects to.

1. Open Freighter's network selector and choose a network:
   * **Mainnet**: the live Stellar network, where transactions move real funds.
   * **Testnet**: a test network with no real value, meant for experimenting.
2.  Soroswap is live on Mainnet. This tutorial uses Testnet so you can explore every feature without risking real funds.

    ![](/images/tutorials/installing-freighter/testnet.png)
