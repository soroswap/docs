...
description: "Removing liquidity from a Soroswap pool, from selecting a position to confirming the transaction."
---
...
![Liquidity page](/images/tutorials/remove-liquidity/liquidity1.png)
...
![Select liquidity position](/images/tutorials/remove-liquidity/liquidity2.png)
...
![Remove liquidity](/images/tutorials/remove-liquidity/liquidity3.png)

2. Click the "Remove" button.

![Confirm removal](/images/tutorials/remove-liquidity/liquidity4.png)
...
## Step 5: View the transaction details
