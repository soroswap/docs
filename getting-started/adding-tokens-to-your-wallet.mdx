---
title: "Adding Tokens to Your Wallet"
description: "To add a specific token to your Stellar wallet, you need the following asset information. We'll use the example of the USDC token issued by the account mentioned."
---
...
1. **Open Your Stellar Wallet**:
   * [Access your Stellar wallet](/getting-started/wallet-setup) (e.g., [Lobstr Wallet](https://lobstr.co/), [Freighter Wallet](https://www.freighter.app/) , [XBull Wallet](https://xbull.app/), etc.).
2. **Navigate to the Assets or Trustlines Section**:
   * Look for the option to add or manage [trustlines](/concepts/trustlines) in your wallet.
