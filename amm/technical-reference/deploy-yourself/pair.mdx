---
title: "Experiment the Pair contract"
description: "Compile, deploy, and test the SoroswapPair contract: deposit, swap, and withdraw with the CLI."
---
...
If you want to continue experimenting directly with the CLI, here are some env variable settings that might be useful
