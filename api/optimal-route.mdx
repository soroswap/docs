---
title: "Optimal Route"
description: "Soroswap's optimal routing architecture, with background on how Uniswap, PancakeSwap, and 1inch route swaps."
---
...
1inch also have their OneSplit smartcontract which serves as an agregator, the information can be found [here](/aggregator/technical-reference/inspirations/1inch)
...
![](/images/api/optimal-route/draw.png)
...
[soroswap-router-sdk on npm](https://www.npmjs.com/package/soroswap-router-sdk)
